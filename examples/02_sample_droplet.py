...
def gibbs_sampling(L=128, ins=1,
                   rot=0, beta=4,
...
if __name__ == "__main__":
    ...
    keep_time = time.time()
    ins = gibbs_sampling(L=args.L, ins=args.ins, rot=args.r, beta=args.b, M=args.M, precondition=args.pre)
    ...
    # save it to ./temp/*.txt
    filename = './temp/gibbs_L=%1d_ins=%03d_r=%1d_beta=%0.2f_M=%1d_pre=%1d.txt' \
               % (args.L, args.ins, args.r, args.b, args.M, args.pre)
    f = open(filename, 'w')
